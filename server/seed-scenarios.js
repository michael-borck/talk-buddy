// Seed scenarios with .env file authentication
// Setup: 
// 1. Copy .env.example to .env
// 2. Add your admin credentials
// 3. Run: node seed-scenarios.js
...
async function seedScenarios() {
  ...
  console.log('🌱 TalkBuddy Scenario Seeder\n');
  ...
  try {
    ...
    console.log('Please check your admin credentials in .env and try again.');
  }
}
